###########################################################################
## Makefile generated for component 'Six_Step_Arduino_Simulink'. 
## 
## Makefile     : Six_Step_Arduino_Simulink.mk
## Generated on : Wed May 05 15:22:19 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Six_Step_Arduino_Simulink.elf
...
PRODUCT_NAME              = Six_Step_Arduino_Simulink
MAKEFILE                  = Six_Step_Arduino_Simulink.mk
MATLAB_ROOT               = C:/PROGRA~1/POLYSP~1/R2020b
MATLAB_BIN                = C:/PROGRA~1/POLYSP~1/R2020b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/HP/Documents/GitHub/BLDC_Model_Based_System
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH        = C:/Users/HP/DOCUME~1/MATLAB/R2020b/ARDUIN~1/ARDUIN~1/FASTER~1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Six_Step_Arduino_Simulink.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/shared/svd/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/SUPPOR~1/ARDUIN~2/include -I$(START_DIR)/Six_Step_Arduino_Simulink_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -IC:/Users/HP/Desktop/LEARNI~1/ARDUIN~1/blocks -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/mega -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/SUPPOR~1/ARDUIN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/SUPPOR~1/ARDUIN~1/SCHEDU~1/include -I$(ARDUINO_ROOT)/hardware/tools/avr/avr/include/avr -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/shared/EXTERN~1/include
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=5 -DMW_PRESCALAR=64 -DMW_TIMERCOUNT=65511 -DMW_SCHEDULERCOUNTER=1 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_BAUDRATE_SERIAL2_=9600 -D_RTT_BAUDRATE_SERIAL3_=9600 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=Six_Step_Arduino_Simulink -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_AnalogInput.o ArduinoPinHandleMap.o MW_arduino_digitalio.o Six_Step_Arduino_Simulink.o Six_Step_Arduino_Simulink_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o io_wrappers.o MW_ArduinoHWInit.o arduinoAVRScheduler.o
...
%.o : C:/Users/HP/Desktop/Learning_Programming/arduino_ec_target/blocks/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : C:/Users/HP/Desktop/Learning_Programming/arduino_ec_target/blocks/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : C:/Users/HP/Desktop/Learning_Programming/arduino_ec_target/blocks/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Six_Step_Arduino_Simulink_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Six_Step_Arduino_Simulink_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Six_Step_Arduino_Simulink_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Six_Step_Arduino_Simulink.o : $(START_DIR)/Six_Step_Arduino_Simulink_ert_rtw/Six_Step_Arduino_Simulink.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Six_Step_Arduino_Simulink_data.o : $(START_DIR)/Six_Step_Arduino_Simulink_ert_rtw/Six_Step_Arduino_Simulink_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Six_Step_Arduino_Simulink_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/Six_Step_Arduino_Simulink_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/Six_Step_Arduino_Simulink_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/Six_Step_Arduino_Simulink_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
